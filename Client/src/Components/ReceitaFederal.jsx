...
function DetalhesReceita({ agendamento, onVoltar, onSucesso }) {
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3 text-left text-xs font-numeric text-gray-500 uppercase tracking-wider">Tipo de agendamento</th>
                            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Data do agendamento</th>
                            ...
                            <tr key={agendamento._id}>
                                ...
                                <td className="px-6 py-4 whitespace-pre-wrap text-sm text-gray-900">
                                    ...
                                    {agendamento.atendimentosComplementares.length > 0 && (
                                        <span className="ml-2 text-xs text-gray-500">(+{agendamento.atendimentosComplementares.length} extra)</span>
                                    )}
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{formatarData(agendamento.data)}</td>
